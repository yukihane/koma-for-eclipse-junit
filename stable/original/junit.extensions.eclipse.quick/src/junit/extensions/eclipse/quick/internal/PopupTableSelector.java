...
public class PopupTableSelector {
    ...
    public PopupTableSelector(final Shell shell, final List items) {
        this.shell = shell;
        this.items = items;
    }

    public void setCommandBackward(final String string) {
        commandBackward = string;
    }

    public void setCommandForward(final String string) {
    ...
    private void addItems(final Table table, final List items) {
    ...
    private void addKeyListener(final Table table, final Shell dialog) {
        table.addKeyListener(new KeyListener() {
            ...
            public void keyPressed(final KeyEvent e) {
                ...
                final KeyStroke keyStroke = SWTKeySupport.convertAcceleratorToKeyStroke(accelerator);
    ...
    private void cancel(final Shell dialog) {
        selection = null;
        dialog.close();
    }

    private void ok(final Shell dialog, final Table table) {
